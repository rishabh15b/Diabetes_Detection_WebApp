...
subheader('Model Test Accuracy Score:')
write(str(accuracy_score(Y_test, RandomForestClassifier.predict(X_test)) * 100) + '%')
...
subheader('Classification: ')
write(prediction)
>>>>>>> 3fe7df22a713ee735490c94a226e238e040d8879
